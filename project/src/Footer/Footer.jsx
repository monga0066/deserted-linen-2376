...
export default function Footer() {
  return (
    <div className='main-footer'>
      ...
      {/*footer 2nd css insta facebook ke baad vali*/}
      <div className='main-footer-down-2'>
        <div className='footer-link'>
          <a className='footer-link-a' href="#">
          WHO WE ARE
          </a>
          <a className='footer-link-a' href="#">
        ...
        <div className='footer-link-ic'>
        <i  className="fa-brands fa-facebook footer-ic"></i>
        <i className="fa-brands fa-instagram footer-ic"></i>
        <i className="fa-brands fa-twitter footer-ic"></i>
        <i className="fa-brands fa-youtube footer-ic"></i>
        </div>
      </div>
      {/*footer 2nd css insta facebook ke baad vali*/}
      {/* -------------- */}
      {/* 2002 provacy ala html */}

      <div className='main-footer-down-3'>
        <div className='footer-link1'>
          <a className='footer-link-b' href="#">
          © 2022 NNNOW
          </a>
          <a className='footer-link-b' href="#">
          Privacy Policy
